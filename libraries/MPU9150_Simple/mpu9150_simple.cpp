...
int mpu9150_update() {
	...
	quaternionToEuler( &q._f, &mpu9150.ypr[2], &mpu9150.ypr[1], &mpu9150.ypr[0] );
	...
	/* then do:  mpu9150.ypr[x] = wrap_180(90.f+rad2deg(mpu9150.ypr[x])); */
	mpu9150.ypr[0] = rad2deg(mpu9150.ypr[0]);
	mpu9150.ypr[1] = rad2deg(mpu9150.ypr[1]);
	mpu9150.ypr[2] = rad2deg(mpu9150.ypr[2]);

	/* need to adjust signs depending on the MPU mount orientation */ 
	mpu9150.gyro[0] = -(float)gyro[2] / GYRO_SENS;
	mpu9150.gyro[1] = (float)gyro[1] / GYRO_SENS;
	mpu9150.gyro[2] = (float)gyro[0] / GYRO_SENS;
